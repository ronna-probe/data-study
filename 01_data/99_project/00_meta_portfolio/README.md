...
본 프로젝트는 '포트폴리오에 대한 이해가 질문과 의사결정을 통해 어떻게 재구성되는지'를 분석 대상으로 삼는다.
...
본 프로젝트에서는 포트폴리오 형성 과정을 관찰하며,
과정 속에서 의미 있는 지표가 발견될 경우 이를 정의하고 수정한다.

---

## 3. 프레임워크

본 프로젝트는 고정된 프레임워크를 전제로 하지 않는다.

질문 로그를 관찰하며,
포트폴리오 이해 과정에서 반복적으로 나타나는 패턴을
점진적으로 구조화한다.

프레임워크 또한 관찰 대상의 일부이다.
