🔗 [Source](https://ebook-product.kyobobook.co.kr/dig/epd/ebook/E000005479126)
...
- 잘 그려진 그래프 결과물보다, 객체 하나하나를 조립해나가는 과정이 더 인상 깊게 남았다.

---

## 활용

- 향후 Seaborn, Plotly 등 다른 시각화 라이브러리 학습의 기반이 될 것이다.
- 그래프의 재현성 확보 및 시각화 자동화 측면에서도 활용될 수 있을 것 같다.
