...
질문 하나에 대해 즉각적인 결정보다는, 이해가 충분히 정리될 때까지  
반복적으로 질문을 확장한 뒤 최종 요약으로 수렴하는 흐름이 주를 이루고 있다.
...
질문 로그를 검토한 결과, question_type만으로는  
질문이 다루는 학습 대상의 성격을 충분히 구분하기 어려운 경우가 확인되었다.

동일한 definition 또는 design 질문이라도  
포트폴리오 설계, 분석적 사고, 기술 학습 등 서로 다른 맥락을 가질 수 있었으며,  
